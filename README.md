...
C:\publish\encoders\citation_encoder.py:11: UserWarning: There exist node types ({'author'}) whose representations do not get updated during message passing as they do not occur as destination type in any edge type. This may lead to unexpected behavior.
  self.conv1 = HeteroConv({
C:\publish\encoders\citation_encoder.py:16: UserWarning: There exist node types ({'author'}) whose representations do not get updated during message passing as they do not occur as destination type in any edge type. This may lead to unexpected behavior.
...
MuPDF error: syntax error: could not parse color space (291 0 R)

MuPDF error: syntax error: could not parse color space (387 0 R)

MuPDF error: syntax error: could not parse color space (444 0 R)
